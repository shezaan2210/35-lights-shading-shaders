...
directionHelper.material.color.setRGB(.1, .1, 1)
directionHelper.material.side = THREE.DoubleSide
directionHelper.position.set(0, 0, 3)
...
pointHelper.material.side = THREE.DoubleSide
pointHelper.position.set(0, 2.5, 0)
